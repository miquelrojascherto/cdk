...
public class AtomTypeMatcher {
    ...
    public IAtomType findMatchingAtomType(IAtom atom)
        ...
        case 2: return perceiveHelium(atomNumber);
        case 3: return perceiveLithium(atomNumber);
        case 4: return perceiveBeryllium(atomNumber);
        case 5: return perceiveBorons(atomNumber);
        case 6: return perceiveCarbons(atomNumber);
        case 7: return perceiveNitrogens(atomNumber);
        case 8: return perceiveOxygens(atomNumber);
        case 9: return perceiveFluors(atomNumber);
        case 10: return perceiveNeon(atomNumber);
        case 11: return perceiveSodium(atomNumber);
        case 12: return perceiveMagnesium(atomNumber);
        case 13: return perceiveAluminium(atomNumber);
        case 14: return perceiveSilicon(atomNumber);
        case 15: return perceivePhosphors(atomNumber);
        case 16: return perceiveSulphurs(atomNumber);
        case 17: return perceiveChlorine(atomNumber);
        case 18: return perceiveArgon(atomNumber);
        case 19: return perceivePotassium(atomNumber);
        case 20: return perceiveCalcium(atomNumber);
        case 34: return perceiveSelenium(atomNumber);
        case 35: return perceiveBromine(atomNumber);
        case 52: return perceiveTellurium(atomNumber);
        case 53: return perceiveIodine(atomNumber);
        case 84: return perceivePolodium(atomNumber);
        }
        switch (symbol) {
        case "Cr": return perceiveChromium(atomNumber);
        case "Mo": return perceiveMolybdenum(atomNumber);
        case "Rb": return perceiveRubidium(atomNumber);
        case "Cu": return perceiveCopper(atomNumber);
        case "Ba": return perceiveBarium(atomNumber);
        case "Ga": return perceiveGallium(atomNumber);
        case "Ru": return perceiveRuthenium(atomNumber);
        case "Zn": return perceiveZinc(atomNumber);
        case "Ni": return perceiveNickel(atomNumber);
        case "Gd": return perceiveGadolinum(atomNumber);
        case "Ge": return perceiveGermanium(atomNumber);
        case "Co": return perceiveCobalt(atomNumber);
        case "Sb": return perceiveAntimony(atomNumber);
        case "V": return perceiveVanadium(atomNumber);
        case "Ti": return perceiveTitanium(atomNumber);
        case "Sr": return perceiveStrontium(atomNumber);
        case "Pb": return perceiveLead(atomNumber);
        case "Tl": return perceiveThallium(atomNumber);
        case "Pt": return perceivePlatinum(atomNumber);
        case "Hg": return perceiveMercury(atomNumber);
        case "Fe": return perceiveIron(atomNumber);
        case "Ra": return perceiveRadium(atomNumber);
        case "Au": return perceiveGold(atomNumber);
        case "Ag": return perceiveSilver(atomNumber);
        case "In": return perceiveIndium(atomNumber);
        case "Pu": return perceivePlutonium(atomNumber);
        case "Th": return perceiveThorium(atomNumber);
        case "Mn": return perceiveManganese(atomNumber);
        case "As": return perceiveArsenic(atomNumber);
        case "Cd": return perceiveCadmium(atomNumber);
        case "W": return perceiveTungstun(atomNumber);
        case "Kr": return perceiveKrypton(atomNumber);
        case "Xe": return perceiveXenon(atomNumber);
        case "Rn": return perceiveRadon(atomNumber);
        case "Sn": return perceiveStannum(atomNumber);
        case "Sc": return perceiveScandium(atomNumber);
        }
        return type;
    }
