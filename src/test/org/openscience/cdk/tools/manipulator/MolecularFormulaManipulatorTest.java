...
public class MolecularFormulaManipulatorTest extends CDKTestCase {
    ...
    public void testGetMajorIsotopeMolecularFormula_String_IChemObjectBuilder() throws Exception {
		...
		Assert.assertEquals(2, mf2.getIsotopeCount());
		IIsotope carbon = BODRIsotopes.getInstance().getMajorIsotope("C");
		IIsotope hydrogen = BODRIsotopes.getInstance().getMajorIsotope("H");
    ...
    public void testGetNaturalExactMass_IMolecularFormula() throws Exception {
        ...
        expectedMass += BODRIsotopes.getInstance().getNaturalMass(builder.newInstance(IElement.class,"C"));
        expectedMass += BODRIsotopes.getInstance().getNaturalMass(builder.newInstance(IElement.class,"Cl"));
    ...
    public void testGetMajorIsotopeMass_IMolecularFormula() throws Exception {
        ...
        double expectedMass = 0.0;
        expectedMass += BODRIsotopes.getInstance().getMajorIsotope("C").getExactMass();
        expectedMass += 4.0*BODRIsotopes.getInstance().getMajorIsotope("H").getExactMass();
