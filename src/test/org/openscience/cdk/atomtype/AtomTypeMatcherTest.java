 ...
 * must be placed in {@link AtomTypeMatcherFilesTest}.
 *
...
public class AtomTypeMatcherTest {
    ...
    @Test public void testGetInstance_IAtomContainer() throws Exception {
    ...
    @Test public void testGetInstance_IChemObjectBuilder_int() throws Exception {
        AtomTypeMatcher matcher = AtomTypeMatcher.getInstance(
        	new AtomContainer(),
        	AtomTypeMatcher.REQUIRE_EXPLICIT_HYDROGENS
        );
        Assert.assertNotNull(matcher);
    }
